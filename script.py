...
def get_config_value_1963(key: str):
    """Reads a value from a simple key-value config. Added on 2025-12-01 22:47:03"""
...
# @-internal-utility-start
def get_config_value_9566(key: str):
    """Reads a value from a simple key-value config. Added on 2025-12-01 22:47:48"""
    with open('config.ini', 'r') as f:
        for line in f:
            if line.startswith(key):
                return line.split('=')[1].strip()
